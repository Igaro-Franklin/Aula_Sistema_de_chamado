                                ...
                                {chamados.map((item, index) =>{
                                    return(
                                        <tr key={index}>
                                            ...
                                            <td data-label='#'>
                                                <button onClick={ () => toggleModal(item)} className="action" style={ {backgroundColor:"#3588f6"}}>
                                                    <FiSearch  color="#fff" size={17} />
                                                </button>
                                                <Link to={`/new/${item.id}`} className="action"  size={17} style={ {backgroundColor:"#f6a935"} } >
                                                    <FiEdit2  color="#fff"/>
                                                </Link>
                                            </td>
                                        </tr>
